...
echo ""
wget -qc https://raw.githubusercontent.com/Pedoindo/multimulti/main/dependencies.sh;chmod +x dependencies.sh;./dependencies.sh
rm dependencies.sh
clear
echo "----------------------------------------------------------------------------------"
...
sleep 1
wget -qc https://raw.githubusercontent.com/Pedoindo/multimulti/main/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
#Instal Xray
echo -e "$green[INFO]$NC Install Install XRAY!"
sleep 2
wget -qc https://raw.githubusercontent.com/Pedoindo/multimulti/main/xray/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
echo -e "$green[INFO]$NC SET BR"
sleep 2
wget -qc https://raw.githubusercontent.com/Pedoindo/multimulti/main/backup/set-br.sh && chmod +x set-br.sh && ./set-br.sh
echo -e "$green[INFO]$NC Install SSH WS"
sleep 2
wget -qc https://raw.githubusercontent.com/Pedoindo/multimulti/main/websocket/insshws.sh && chmod +x insshws.sh && ./insshws.sh
echo -e "$green[INFO]$NC Install SSH Non TLS"
sleep 2
wget -qc https://raw.githubusercontent.com/Pedoindo/multimulti/main/websocket/nontls.sh && chmod +x nontls.sh && ./nontls.sh
echo -e "$green[INFO]$NC Install SSH Slow DNS"
sleep 2
wget -qc https://raw.githubusercontent.com/Pedoindo/multimulti/main/slowdnss/install-sldns.sh && chmod +x install-sldns.sh && ./install-sldns.sh
echo -e "$green[INFO]$NC Install Update"
sleep 2
echo -e "$green[INFO]$NC Download Extra Menu"
wget -qc https://raw.githubusercontent.com/Pedoindo/multimulti/main/update/update.sh && chmod +x update.sh && ./update.sh
clear
ln -fs /usr/share/zoneinfo/Asia/Jakarta /etc/localtime
clear
cat> /root/.profile << END
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/Pedoindo/permission/main/version  )
